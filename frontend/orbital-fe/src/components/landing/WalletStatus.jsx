...
export default function WalletStatus({ onSignOut, evmAddress }) {
    ...
    const renderTokenCard = (addr, tokenAddress) => {
        ...
        return (
            <div className="card-interactable" style={{ width: 'calc(50% - 5px)', maxWidth: 'calc(50% - 5px)', flex: '0 0 calc(50% - 5px)', boxSizing: 'border-box' }} key={`${addr}-${tokenAddress}`}>
    ...
    return (
        <div className="stack" style={{ gap: 6, marginTop: 16 }}>
            <div className="stack" style={{ gap: 6 }}>
                ...
                <div className="helper" style={{ marginTop: 0 }}>Select a stable coin to pay with</div>
            </div>
                    ...
                    <div className="row" style={{ gap: 10, flexWrap: 'wrap' }}>
                        {addresses.map((addr) => (
                            <React.Fragment key={addr}>
                                ...
                                {TOKENS.map((t) => renderTokenCard(addr, t.address))}
                            </React.Fragment>
                        ))}
                        {addresses.length === 0 && (
